...
HMODULE hFTDll = NULL;
#else
void* hFTDll = NULL; // Sous Android/Linux, un handle de lib dynamique est un pointeur void*
#endif
...
#ifdef _WIN64
	const char* LibName = "libfreetype-21-64.dll";
#else
	const char* LibName = "libfreetype-21-32.dll";
#endif
